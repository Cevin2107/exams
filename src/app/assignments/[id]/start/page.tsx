          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative group/input mt-1">
                <input
                  id="studentName"
                  type="text"
                  className="peer w-full rounded-xl border-2 border-slate-200/80 bg-white/50 backdrop-blur-sm px-4 py-3.5 text-base text-slate-900 placeholder-transparent transition-all focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-indigo-500/10 hover:border-slate-300 hover:bg-white"
                ...
                <label 
                  htmlFor="studentName" 
                  className="absolute left-4 top-3.5 origin-[0] -translate-y-6 scale-75 transform text-sm font-bold text-slate-500 transition-all peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:font-normal peer-placeholder-shown:text-slate-400 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-bold peer-focus:text-indigo-600 cursor-text pointer-events-none"
                >
            ...
            {!incompleteSession && (
              <button
                ...
                className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 disabled:opacity-50 px-4 py-3.5 text-sm font-bold text-white transition-all shadow-lg shadow-indigo-600/20 hover:shadow-indigo-600/40 hover:-translate-y-0.5 active:translate-y-0"
              >
