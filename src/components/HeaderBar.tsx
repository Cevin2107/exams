      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3" suppressHydrationWarning>
        <div className="flex items-center gap-2.5" suppressHydrationWarning>
          ...
          <div suppressHydrationWarning>
            <p className="text-sm font-bold text-slate-900 leading-tight">Gia sư Đào Bá Anh Quân</p>
            {greeting && (
        ...
        <Link
          href="/admin"
          className="flex items-center gap-1.5 rounded-xl border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700"
        >
